...
import argparse, sys, serial, threading
...
def runML(model: str, camera_id: int, width: int, height: int, num_threads: int, data:dict, lock: threading.Lock):
    global frame
...
if __name__ == '__main__':
    ...
    try:
        args = initML()
        runML(args.model, int(args.cameraId), args.frameWidth, args.frameHeight,int(args.numThreads), data,lock)
        endML()
